# expense-tracker-
A simple Python-based CLI tool to record, manage, and analyze your daily expenses using CSV storage.
Expense Tracker – Python CLI Application
# Overview

The Expense Tracker is a simple, offline, Python-based command-line application that helps users record, manage, and analyze their daily expenses.
It uses a CSV file for storage—making it lightweight, portable, and easy to understand for beginners and students.
